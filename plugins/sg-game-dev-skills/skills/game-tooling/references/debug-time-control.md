...
2. 調打擊感：逐幀數 hitstop 的幀數、檢查回饋層是否同幀觸發（見 `../../game-design/references/feel-impact-feedback.md`）。
3. 數輸入反應：按鍵到第一個視覺變化隔幾幀（見 `../../game-design/references/feel-input-responsiveness.md` 的 100ms 預算）。
